...
attendance_live_tab, start_recognition, stop_recognition, info_labels = create_attendance_live_tab(notebook, width=1020, height=520) # Gọi hàm từ attendance_live_tab.py
attendance_list_tab, attendance_list_app = create_attendance_list_tab(notebook, width=1020, height=520)
employee_management_tab, update_employee_list = create_employee_management_tab(notebook, width=1020, height=520)
add_employee_tab = create_add_employee_tab(notebook, uart.send_command, uart.read_response, width=1020, height=520)
